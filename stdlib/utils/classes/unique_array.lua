...
---@param other unique_array|string|string[]
---@return unique_array self
...
---@param other unique_array|string|string[]
---@return unique_array difference
...
---@param other unique_array|string|string[]
---@return unique_array intersection
...
---@param cmp? function Comparator @{sort} function to use
---@return unique_array self
function M:sort(cmp)
    local class = getmetatable(self)
    t_sort(self, cmp)
...
---@return unique_array matches unique array containing all elements that match
...
---@param other unique_array|string|string[]
---@return boolean contains_all true if every passed string is in the array
...
---@param other unique_array|string|string[]
---@return boolean contains_any true if any passed string is in the array
...
---@param other unique_array|string|string[]
---@return boolean contains_none true if no passed strings are in the array
...
---@param func? function value, index are passed as the first two paramaters
---@param ... any additional values to pass to the function
