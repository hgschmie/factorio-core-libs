...
---@field Assert Is asserts that the test is true; `Assert.Not` asserts that it is not true.
...
---@param var any The variable to check
---@return boolean result true if the passed variable is a single alphbetical word
...
---@return any value the var if this is a LuaObject
...
---@param var LuaObject The variable to check
---@return any value the var if this is a valid LuaObject
