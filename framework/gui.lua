...
---@class framework.gui.custominput_data
---@field player_index integer player information
---@field input_name string the input event that was fired
---@field tick uint32 the tick for the event
...
---@field custominput_events framework.custominput_events? Map of all known custom input events
...
---@field gui_events framework.gui_events All known events for this GUI.
---@field custominput_events framework.custominput_events All known custom inputs for this GUI.
...
function FrameworkGui.create(map)
    ...
    local gui = {
        ...
        type = map.type,
        prefix = map.prefix,
        gui_events = map.gui_events or {},
        custominput_events = map.custominput_events or {},
